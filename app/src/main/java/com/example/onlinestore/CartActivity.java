...
import com.example.onlinestore.Classes.Cart;
import com.example.onlinestore.Classes.CartViewHolder;
    ...
    protected void onStart()
    {
        ...
        FirebaseRecyclerAdapter<Cart, CartViewHolder> adapter
            ...
            protected void onBindViewHolder(@NonNull CartViewHolder holder, int position, @NonNull final Cart model)
            {
                ...
                holder.txtItemName.setText(model.getItemName() +": " + model.getDescription() );
                    ...
                    public void onClick(View view)
                    {
                        ...
                        builder.setItems(options, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i)
                            {
                                if (i == 0)
                                {
                                    Intent intent = new Intent(CartActivity.this, ItemInfoActivity.class);
            ...
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                if (dataSnapshot.exists())
                {
                    ...
                    if (shippingState.equals("shipped"))
                    {
                        ...
                        Toast.makeText(CartActivity.this, "you can purchase more Items, once you received your first final order.", Toast.LENGTH_SHORT).show();
                    }
